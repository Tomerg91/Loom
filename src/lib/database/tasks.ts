...
type DbTaskInstance = Database['public']['Tables']['task_instances']['Row']
type DbTaskCategory = Database['public']['Tables']['task_categories']['Row']
type DbProgressUpdate = Database['public']['Tables']['task_progress_updates']['Row']
