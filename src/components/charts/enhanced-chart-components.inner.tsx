...
export interface EnhancedUserGrowthChartProps extends EnhancedBaseChartProps {
  data: Array<{
    date: string;
    newUsers: number;
    activeUsers: number;
...
export interface EnhancedSessionMetricsChartProps extends EnhancedBaseChartProps {
  data: Array<{
    date: string;
