...
export interface UserGrowthChartProps extends BaseChartProps {
  data: Array<{
    date: string;
    newUsers: number;
    activeUsers: number;
...
export interface SessionMetricsChartProps extends BaseChartProps {
  data: Array<{
    date: string;
...
export interface GoalProgressChartProps extends BaseChartProps {
  data: Array<{
    name: string;
    progress: number;
    color?: string;
...
export interface CompletionRateChartProps extends BaseChartProps {
  data: Array<{
    name: string;
    value: number;
    color?: string;
...
// Components and constants are already exported inline above
